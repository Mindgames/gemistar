 ...
 * Toast UI Components
 *
 * A collection of toast notification components built on top of Radix UI's
 * Toast primitive. These components provide a way to display temporary
 * messages to users with different variants and actions.
 *
 * Features:
 * - Built on Radix UI for accessibility
 * - Multiple variants (default, destructive, secondary)
