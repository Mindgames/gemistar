  ...
  return (
    <motion.div
      ...
      className={clsx(
        ...
        'bg-[radial-gradient(circle_at_center,transparent_25%,color-mix(in_srgb,_theme(colors.blue.500)_var(--opacity),transparent)_100%)]',
...
function MainLogo() {
  return (
    <div className="absolute left-44 top-32 flex size-16 items-center justify-center rounded-full bg-white shadow ring-1 ring-black/5">
      <div className="h-9 w-9 bg-blue-500 rounded text-white flex items-center justify-center font-bold text-lg">
        G
      </div>
    </div>
  );
...
export function LogoCluster() {
  return (
    <div
      aria-hidden="true"
      className="relative h-full overflow-hidden rounded-3xl bg-white shadow-lg"
    >
      <Circles />
